...
function Navigation() {
    ...
    return (
        <Navbar bg="light" expand="lg">
            <Container>
                <LinkContainer to="/">
                    <Navbar.Brand className="navbar-brand-karchi">Karchi Softserv LLP</Navbar.Brand>
                </LinkContainer>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <Nav className="ms-auto">
                        {/* if no user
                        <Nav.Link>Samyak 2GI20CS127</Nav.Link>
                        <Nav.Link>Omkar 2GI20CS079</Nav.Link>
                        <Nav.Link>Arbaaz 2GI20CS018</Nav.Link>
                        <Nav.Link>Tanishka 2GI20CS168</Nav.Link>
                        <Nav.Link>‎ ‎ ‎ ‎</Nav.Link>
                        <Nav.Link>‎ ‎ ‎ ‎</Nav.Link>
                        <Nav.Link>‎ ‎ ‎ ‎</Nav.Link>
                        <Nav.Link>‎ ‎ ‎ ‎</Nav.Link>
